...
char TUNNEL = '#';
int num_rooms = 0;
int room[6][2] = {{4,4}, {4,2}, {4,6}, {5,8}, {8,2}, {10,10}};
int rooms[60][4];
typedef struct {
  char type;
  int hardness;
...
/*
Run this--- betcha can't outrun it doe
 */
int main (int argc, char* argv[]){
	...
	if (((strcmp(argv[1], "--load") == 0) && (strcmp(argv[2], "--save") == 0)) || ((strcmp(argv[1], "--save") == 0) && (strcmp(argv[2], "--load") == 0))){	 
